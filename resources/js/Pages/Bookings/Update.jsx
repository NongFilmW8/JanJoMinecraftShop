...
export default function UpdateBooking({ booking }) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Update Booking</h2>}>
            ...
            <div className="max-w-lg mx-auto mt-10 p-8 border border-gray-300 rounded-lg shadow-lg bg-white">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button type="submit" disabled={processing} className="w-full px-4 py-2 bg-blue-600 text-white font-semibold rounded-md shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
